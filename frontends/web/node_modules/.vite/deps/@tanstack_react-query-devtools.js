"use client";
import { i as __toESM, t as require_react } from "./react-z4uQ-w_V.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { C as useQueryClient, z as onlineManager } from "./modern-B--NOGJx.js";
import { G as setupStyleSheet, I as mergeProps, P as lazy, V as render, m as createComponent, x as createSignal } from "./RJYFHVWH-sjHxXpbu.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./I4EE2JD6-B7qFxbHx.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./C2NHY6T5-BACWdL4w.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
