...
const rental_unit_repository_1 = require("./rental-unit.repository");
...
exports.DatabaseModule = DatabaseModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([rental_unit_entity_1.RentalUnitEntity, reservation_entity_1.ReservationEntity]),
        ],
        providers: [rental_unit_repository_1.RentalUnitRepository, reservation_repository_1.ReservationRepository],
        exports: [rental_unit_repository_1.RentalUnitRepository, reservation_repository_1.ReservationRepository],
    })
], DatabaseModule);
